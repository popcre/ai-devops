...
| Bundled leftover live proofs, one chat given several unproven steps, or “take tickets N, M, and P to production” | [`plan_live-proof-session-sizing.md`](plan_live-proof-session-sizing.md) STATUS | One unproven outcome per session; do not steal work from a live proof owner |
