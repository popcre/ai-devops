...
| Reviewer failure lifecycle diagnostics or quota preflight | [`plan_reviewer-diagnostics-quota-preflight.md`](plan_reviewer-diagnostics-quota-preflight.md) STATUS, issue #312 | Qualify non-generating interfaces first; unknown quota never disables a working reviewer; retain cancellation uncertainty and exact-run evidence |
