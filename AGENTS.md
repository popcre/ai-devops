...
| Windows CI jobs, self-hosted runners, or a local reviewer test series | [`docs/self-hosted-windows-runner.md`](docs/self-hosted-windows-runner.md), [`docs/independent-windows-runner-setup.md`](docs/independent-windows-runner-setup.md), [`docs/critical-incidents.md`](docs/critical-incidents.md) 2026-08-28 | New physical hosts remain on the candidate label until the canonical #209 qualification passes. One runner service per physical host; never use an unqualified host for required CI. This is a public repository: fork-PR approval must stay `all_external_contributors` |
