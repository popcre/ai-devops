...
| C: is full, disk is low, or AI debris is eating the drive | [`docs/disk-space.md`](docs/disk-space.md), then [issue #711](https://github.com/popcre/ai-devops/issues/711) / [issue #768](https://github.com/popcre/ai-devops/issues/768) | Never delete dirty working copies or live repos; keep speed on the SSD and bulk on the HDD; daily sweep is backup only |
