...
| TypeSafe Jev evaluation (compaction, completion-honesty shadow) | [`plan_typesafe-jev-decision-layer.md`](plan_typesafe-jev-decision-layer.md) STATUS | Evaluation only; Jev never opens a gate; key via `op run` only |
