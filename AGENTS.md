...
| Understand why the shared-db orchestrator stayed busy while application database requests crossed sessions or remained unfinished | [`shared-db_orchestrator_failure_analysis.md`](shared-db_orchestrator_failure_analysis.md), then [`fix_reviewer_system.md`](fix_reviewer_system.md) for the reviewer-specific subset | Measure live application outcomes, not occupied lanes or tooling pull requests. Keep platform repair bounded and out of the critical path whenever possible |
