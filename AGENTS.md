...
| Improve GLM, Grok, or Kimi debate continuity and reliability | `plan_glm-service-reliability.md`, `plan_grok-debate-continuity.md`, `plan_kimi-debate-context-continuity.md`, then the integration-specific docs and skill named by that plan | Read each plan's STATUS table first; do not re-plan completed rows |
