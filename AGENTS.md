...
| Incremental reviewer-log repair rounds or scan checkpoints | [`plan_reviewer-log-repair-checkpoints.md`](plan_reviewer-log-repair-checkpoints.md) STATUS, issue #308, [`docs/reviewer-issues.md`](docs/reviewer-issues.md), `ai-reviewer-issue maintenance show`, matching tests | Resume the frozen round; account for every candidate; preserve incidents in place and carry unfinished repairs forward before completing |
