...
| Spec Kit — evaluate, or adopt its ported ideas | `docs/github-spec-kit-evaluation.md`, `plan_spec-kit-idea-adoption.md` (STATUS first) | Do not install `specify-cli` — declined 2026-08-13 |
...
| open | Port five Spec Kit ideas | `plan_spec-kit-idea-adoption.md` — phase 1 (root plans → `specs/`) is next |
