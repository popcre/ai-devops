...
| Bundled leftover live proofs, or leftover proofs saved for a later chat | [`plan_live-proof-session-sizing.md`](plan_live-proof-session-sizing.md) STATUS | One unproven outcome per session; never dump several unproven steps on a later chat |
