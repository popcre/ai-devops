...
- `916` (`<removed-protected-address>:22`) still timed out using Git for Windows SSH with an
...
- SSH to `916` (`<removed-protected-address>:22`) timed out on 2026-08-10. Its machine-local
