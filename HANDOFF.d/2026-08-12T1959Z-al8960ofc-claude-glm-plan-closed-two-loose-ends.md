...
1. **DONE 2026-08-12: `HANDOFF.d/` cleared from 8 files to 3.** Each file was
   ...
   |---|---|
   | `2026-08-10T1138Z-albt16-codex-916-rollout.md` | Genuinely blocked. `916` is still unreachable: `100.110.219.31:22` refused a connection when tested 2026-08-12T1959Z. Its blocker is machine availability, nothing else |
