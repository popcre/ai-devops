...
| 1 | Verify the three lower-tier dispatch paths (read-only) | ✅ done 2026-09-25 | Codex: `codex exec -m <MODEL>` supported (0.153.2 help quoted); Luna slug live-verified later on 2026-09-25 as `gpt-5.6-luna`, headless exposure proven by probe (Albert's ask; [probe comment on #782](https://github.com/popcre/ai-devops/issues/782#issuecomment-5834620657)). ZCode: no headless model selector; manual path + gap [#828](https://github.com/popcre/ai-devops/issues/828). MiMo: CLI absent, `mimo run` flags unqualified (D10); manual path + gap [#829](https://github.com/popcre/ai-devops/issues/829). [Step 1 comment on #782](https://github.com/popcre/ai-devops/issues/782#issuecomment-5827260474) |
