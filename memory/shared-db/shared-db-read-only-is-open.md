...
Only **changes** are gated: every schema/view/RPC/trigger/RLS/index/constraint/seed/migration/data-contract change is still authored in `u2giants/shared-db` first via branch → preview → PR.
