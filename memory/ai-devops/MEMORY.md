...
- Open plan: read `plan_sync-machine-wrapper-reconciliation.md` STATUS first before changing how “sync my dotfiles” installs or verifies local Grok, Kimi, or GLM commands. Do not re-derive the fix from chat.
