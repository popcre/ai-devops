...
- [Grok --worktree is silently ignored](grok-worktree-silently-ignored.md) — headless Grok 0.2.112 ignores --worktree and edits the primary checkout; use `ai-grok-implement`.
