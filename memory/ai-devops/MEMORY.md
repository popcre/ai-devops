...
- [Machine tool sync catalog](machine-tool-sync-catalog.md) — dotfiles sync must reconcile skill-taught Grok, Kimi, DeepSeek, and GLM launchers from one catalog and fail closed when they are missing.
