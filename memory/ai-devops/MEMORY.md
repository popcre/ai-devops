...
- [Safe ai-gemini reviewer plan](ai-gemini-wrapper-plan.md) — issue #38; read the plan STATUS first; Antigravity exact model/resume works, but isolated permissions and hostile read-only canaries are release blockers.
