...
|---|---|---|---|
| 1 | Start-vs-health failure fixtures | ⬜ open | GLM/Windows tests |
| 2 | Make start wait for readiness | ⬜ open | bounded health fixtures |
| 3 | Align diagnostics/docs | ⬜ open | doctor/start artifacts |
| 4 | Live Windows/Ubuntu qualification | ⬜ open | verification bundle |
| 5 | Land and install | ⬜ open | remote SHA/installed hashes |

Fresh session starts at Step 1. Preserve completed reliability work in
