...
| 3 | [#209](https://github.com/popcre/ai-devops/issues/209) | Independent Windows runner pool | in progress; first physical host is isolated and running canonical qualification; second/third hosts, failover, routing and EDGE-DEV retirement remain open | PR #214; Actions run `33544988495`; [`docs/independent-windows-runner-setup.md`](docs/independent-windows-runner-setup.md); [`docs/windows-runner-interruptions-2026-09-01.md`](docs/windows-runner-interruptions-2026-09-01.md) |
