...
| 1. Consume the four independently owned prerequisite repairs | ✅ live-proven | 2026-09-16 | #2705, #2709, #2715 and #2716 are CLOSED. Automatic promotion: canary PR u2giants/shared-db#3046 merged, and production run [35103122149](https://github.com/u2giants/shared-db/actions/runs/35103122149) was dispatched by `github-actions[bot]` (actor and triggering actor) and applied `20260916120643`. Refusal path: bot-dispatched run [35067878423](https://github.com/u2giants/shared-db/actions/runs/35067878423) refused at the business-risk gate before any apply. `20260916120643` is in the production ledger. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 2. Enforce two-sided structural admission, urgent application-unblock priority, and finish-first scheduling | ✅ live-proven | 2026-09-18 | Code: #2727 via PR #2738 (`5d89c5e2`); named holds via u2giants/shared-db PR #3049 (`35fda1f1`). LIVE: version re-reservation without closing the PR (claim #3005 kept, PR #3007 kept, supersession ref `refs/db-claim-supersessions/3005-20260916001923`). LIVE named hold: Guarded Merge runs [35177165797](https://github.com/u2giants/shared-db/actions/runs/35177165797) (PR #3135) and [35177188382](https://github.com/u2giants/shared-db/actions/runs/35177188382) (PR #3141) recorded `hold_reason lease:production held by production lease f726fd1186e5, holder github-actions:35177514199, PR #3118, run 35177514199`; both merged once that production run released. LIVE refusal: on 2026-09-18 `--advance-outcome blocked --issue 3174 --hold-reason "until #3118's production run finishes"` was refused (`a hold whose reason is another item's unrelated pipeline stage is refused`) with #3174's ledger unchanged ([shared-db#3241 comment](https://github.com/u2giants/shared-db/issues/3241#issuecomment-5723926754)). u2giants/shared-db#3027 was closed 2026-09-16 claiming all steps proven; for this row that claim covered the merge only. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. Live proof owner: [shared-db#3241](https://github.com/u2giants/shared-db/issues/3241). |
| 2A. Add a fail-closed no-database-preview fast lane | ✅ live-proven | 2026-09-16 | Authenticated sender-to-receiver canary on live PR u2giants/shared-db#3022: ai-devops sender returned `NO_DATABASE_PREVIEW`, the shared-db receiver re-read the live PR and admitted it with `return-to-natural-owner` in 26 s; a forged head SHA was refused. Ten-minute target met on prose PRs #3022 (7 m 13 s) and #3040 (59 s); not yet measured for a no-database code PR. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 3. Make one outcome card authoritative through live verification | ✅ live-proven (one outcome) | 2026-09-14 | Outcome u2giants/shared-db#2905: production apply of `20260914172031` logged 20:25:39Z (run 34892518005); the application live-proof run [34895253761](https://github.com/u2giants/shared-db/actions/runs/34895253761) started 20:49:49Z, 24 minutes later; the `production_applied` and `live_verified` ledger events carry actor `manage-migration-author-lanes`, not Albert or another session. Counter-example outside the window: #2860 (68 minutes). Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 4. Replace manual polling and session handoffs with durable events and resumable snapshots | ✅ live-proven | 2026-09-17 | Successor resume: a separate successor process verified a predecessor snapshot against live state (`CURRENT`, snapshot `126af262…`) and refused stale snapshots; this was a live canary, not a real orchestrator handover. Alarm installed and firing: `orchestrator-no-progress-alarm.yml` (fixed in PR #3080, `6492c767`) runs on schedule; first live post from run 35129683767 on u2giants/shared-db#3084, and scheduled runs posted there again on 2026-09-16 and 2026-09-17 (for example 14:50Z and 18:55Z runs → 14:51Z and 18:57Z posts). Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 5. Add one early, automatic delivery preflight and evidence registration | ✅ live-proven | 2026-09-17 | Code: early-preflight/pass-2 merged under #2728; sidecar registry via shared-db PRs #2872/#2869. LIVE PROOF 2026-09-17: shared-db run 35197512953 validated all 59 hash-bound production verification sidecars (OK), then production apply ran; migration 20260916232818 (#2869) is live and shared-db#2866 closed verified 08:07Z. Proof owner: [shared-db#3028](https://github.com/u2giants/shared-db/issues/3028). Step 7A shared-db leftover proof: [shared-db#3239](https://github.com/u2giants/shared-db/issues/3239). |
...
| 7. Bound reviewer and runner waits with truthful fallback | 🟨 runner live-proven; reviewer not within SLO | 2026-09-18 | Runner: staged non-pickup run 35108728953 was rerouted at 10 m 23 s to replacement run [35109943926](https://github.com/u2giants/shared-db/actions/runs/35109943926) (success), while healthy run 35108725806 ran to completion uncancelled. Reviewer: an unstarted Muse slot on PR u2giants/shared-db#3098 was returned and redrawn to glm-5.3 by `reviewer-start-watch.mjs` (fix PR #3101, `b063823f`), but the watcher was run by hand and the reroute ref was written 20:47:30Z, 62 minutes after the 19:45:26Z draw. NOT ACCEPTED: no scheduled watcher enforces the ten-minute reviewer start SLO, and no live reviewer reroute within it exists. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. Live proof owner: [shared-db#3242](https://github.com/u2giants/shared-db/issues/3242). |
