...
| 1. Consume the four independently owned prerequisite repairs | ✅ live-proven | 2026-09-16 | #2705, #2709, #2715 and #2716 are CLOSED. Automatic promotion: canary PR popcre/shared-db#3046 merged, and production run [35103122149](https://github.com/popcre/shared-db/actions/runs/35103122149) was dispatched by `github-actions[bot]` (actor and triggering actor) and applied `20260916120643`. Refusal path: bot-dispatched run [35067878423](https://github.com/popcre/shared-db/actions/runs/35067878423) refused at the business-risk gate before any apply. `20260916120643` is in the production ledger. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 2. Enforce two-sided structural admission, urgent application-unblock priority, and finish-first scheduling | ✅ live-proven | 2026-09-18 | Code: #2727 via PR #2738 (`5d89c5e2`); named holds via popcre/shared-db PR #3049 (`35fda1f1`). LIVE: version re-reservation without closing the PR (claim #3005 kept, PR #3007 kept, supersession ref `refs/db-claim-supersessions/3005-20260916001923`). LIVE named hold: Guarded Merge runs [35177165797](https://github.com/popcre/shared-db/actions/runs/35177165797) (PR #3135) and [35177188382](https://github.com/popcre/shared-db/actions/runs/35177188382) (PR #3141) recorded `hold_reason lease:production held by production lease f726fd1186e5, holder github-actions:35177514199, PR #3118, run 35177514199`; both merged once that production run released. LIVE refusal: on 2026-09-18 `--advance-outcome blocked --issue 3174 --hold-reason "until #3118's production run finishes"` was refused (`a hold whose reason is another item's unrelated pipeline stage is refused`) with #3174's ledger unchanged ([shared-db#3241 comment](https://github.com/popcre/shared-db/issues/3241#issuecomment-5723926754)). popcre/shared-db#3027 was closed 2026-09-16 claiming all steps proven; for this row that claim covered the merge only. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. Live proof owner: [shared-db#3241](https://github.com/popcre/shared-db/issues/3241). |
| 2A. Add a fail-closed no-database-preview fast lane | ✅ live-proven | 2026-09-16 | Authenticated sender-to-receiver canary on live PR popcre/shared-db#3022: ai-devops sender returned `NO_DATABASE_PREVIEW`, the shared-db receiver re-read the live PR and admitted it with `return-to-natural-owner` in 26 s; a forged head SHA was refused. Ten-minute target met on prose PRs #3022 (7 m 13 s) and #3040 (59 s); not yet measured for a no-database code PR. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 3. Make one outcome card authoritative through live verification | ✅ live-proven (one outcome) | 2026-09-14 | Outcome popcre/shared-db#2905: production apply of `20260914172031` logged 20:25:39Z (run 34892518005); the application live-proof run [34895253761](https://github.com/popcre/shared-db/actions/runs/34895253761) started 20:49:49Z, 24 minutes later; the `production_applied` and `live_verified` ledger events carry actor `manage-migration-author-lanes`, not Albert or another session. Counter-example outside the window: #2860 (68 minutes). Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 4. Replace manual polling and session handoffs with durable events and resumable snapshots | ✅ live-proven | 2026-09-17 | Successor resume: a separate successor process verified a predecessor snapshot against live state (`CURRENT`, snapshot `126af262…`) and refused stale snapshots; this was a live canary, not a real orchestrator handover. Alarm installed and firing: `orchestrator-no-progress-alarm.yml` (fixed in PR #3080, `6492c767`) runs on schedule; first live post from run 35129683767 on popcre/shared-db#3084, and scheduled runs posted there again on 2026-09-16 and 2026-09-17 (for example 14:50Z and 18:55Z runs → 14:51Z and 18:57Z posts). Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 5. Add one early, automatic delivery preflight and evidence registration | ✅ live-proven | 2026-09-17 | Code: early-preflight/pass-2 merged under #2728; sidecar registry via shared-db PRs #2872/#2869. LIVE PROOF 2026-09-17: shared-db run 35197512953 validated all 59 hash-bound production verification sidecars (OK), then production apply ran; migration 20260916232818 (#2869) is live and shared-db#2866 closed verified 08:07Z. Proof owner: [shared-db#3028](https://github.com/popcre/shared-db/issues/3028). Step 7A shared-db leftover proof: [shared-db#3239](https://github.com/popcre/shared-db/issues/3239). |
| 6. Add the governed approved-migration train | ✅ live-proven | 2026-09-16 | Canary train `20260916160617` + `20260916184821` (PRs #3073, #3090): merged-main preview run 35138814669 added both; production dry-run 35139306332 listed exactly both; a variant including an applied version was refused by name (`REFUSED: migration 20260916120643 is already applied on the exact target`); one production dispatch [35140328371](https://github.com/popcre/shared-db/actions/runs/35140328371) with the train ref applied both; the train closed with passing assertions. Both versions are in the production ledger. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. |
| 7. Bound reviewer and runner waits with truthful fallback | ✅ live-proven | 2026-09-18 | Runner: staged non-pickup run 35108728953 was rerouted at 10 m 23 s to replacement run [35109943926](https://github.com/popcre/shared-db/actions/runs/35109943926) (success), while healthy run 35108725806 ran to completion uncancelled. Reviewer: `reviewer-start-watch.mjs` now runs unattended every 2 minutes from the edge-dev scheduled task `i-devops
eviewer-start-watch` (#599; a GitHub-hosted runner lacks `ai-review-preflight`). On staged shared-db PR #3286, unstarted slot 2 (seq 3319, grok-4.6, drawn 22:37:41Z) was reserved for reroute at 22:48:34Z, 53 s after its 10-minute SLO, and the replacement (seq 3323, muse-spark-1.3-contributor) was acknowledged at 22:49:55Z by the first edge-dev pass after the SLO. The slot 1 lease (seq 3318) was not touched. Accepted reading: "within 10 minutes" means the first watcher pass after the 10-minute SLO. Enabling fixes: shared-db #3272 and #3284 (`c9d50300`). Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-18-step-7-unattended-reroute.md` (merge `b406395a`). Live proof owner: [shared-db#3242](https://github.com/popcre/shared-db/issues/3242). |
| 7A. Remove every numeric concurrency ceiling on sub-agents, runners, and same-reviewer reviews | ✅ live-proven on both sides (ai-devops [#531](https://github.com/popcre/ai-devops/pull/531); shared-db [popcre/shared-db#3132](https://github.com/popcre/shared-db/pull/3132), proof issue popcre/shared-db#3239) | 2026-09-18 | Added by Albert's ruling 2026-09-16 (locked decisions 20–21). ai-devops: `ai-kimi`/`ai-qwen` review locks re-keyed per review session, `ai-gemini` repository lock removed, orchestrator skill cap/slot/reviewer-busy text removed; workflows had no serializing cap. Live proof 2026-09-17: three Kimi reviews ran at once on PRs #529, #520, #486 (all `running` at 08:23:12Z; finished 08:27:58–08:28:18Z), each with its own verdict (APPROVE, REJECT, REJECT). Unrelated PRs' `linux-offline` runner jobs overlapped without waiting (#529-branch 01:44–02:05Z, #530 01:52–02:13Z, queue #524 01:59–02:19Z). shared-db live proof (read 2026-09-18 from the live `refs/db-review-active-v2` and `refs/db-review-started` refs; shared-db reviews run as recorded review sequences, not Actions runs): after #3132 merged at 2026-09-17T05:50:48Z, `grok-4.6` held three live exact-head review leases at once — sequence 3133 (issue 3173 / PR 3172, started 11:13:26Z, lease `cb7cf682` still held), 3181 (2406 / PR 3215, started 17:03:09Z) and 3211 (3235 / PR 3236, started 2026-09-18T00:55:52Z) — and started sequences 3193, 3198 and 3204 in between without any busy wait or refusal. `glm-5.3` likewise held 3104, 3182, 3194 and 3200 at once, and `muse-spark-1.3-contributor` held 3190, 3201 and 3207. Non-orchestrator tooling (no database structure change). |
...
- `shared-db/scripts/manage-migration-author-lanes.mjs` currently imposes a numeric active-author ceiling. [shared-db #2773](https://github.com/popcre/shared-db/issues/2773) removes that ceiling while retaining exact read/write conflict claims, permanent migration-version reservations, lease recovery, and fail-closed unreadable-state behavior.
...
- `popcre/shared-db/plan_shared_db_popcre_transfer_merge_queue.md` comprehensively plans the organization transfer and native queue; all execution rows remain open.

### Partially addressed now

- [shared-db #2705](https://github.com/popcre/shared-db/issues/2705) covers only allocation of a reviewer whom the same preflight declares unusable. PR #2717 was open at head `1f686f0e` on 2026-09-11 and had failing contract/collision checks; re-resolve before acting.
- [shared-db #2709](https://github.com/popcre/shared-db/issues/2709) covers only the wrong comparison base in governed reviewer packets after updating from `main`. `popcre/ai-devops` PR #402 was open at head `407fedbe` on 2026-09-11; re-resolve before acting.
- [shared-db #2715](https://github.com/popcre/shared-db/issues/2715) covers the docs-only pull-request deadlock caused by requiring a migration guarded-merge status that no lightweight path posts. It belongs in this programme as a prerequisite to removing maintenance from the orchestrator, but must be implemented by its own repo-maintenance session, not the orchestrator.
- [shared-db #2716](https://github.com/popcre/shared-db/issues/2716) proposes automatic serial production promotion after governed review, guarded merge, post-merge preview, dry-run, and automatic evidence gates. It directly addresses repeated technical authorization asks and the unapplied-migration backlog. It belongs in this programme, but its cross-repository policy/workflow implementation must remain independently owned and must not be performed inside the orchestrator context.
...
20. **No numeric ceiling on concurrent sub-agents, lanes, or runners.** Any number of sub-agents, author lanes, and CI runner jobs may run at once. The only admission controls are exact read/write object conflicts, permanent version reservations, the serialized preview/merge/production stage leases, and real provider or machine refusals (rate limit, out-of-memory, quota), which are handled by back-off and reroute, never by a fixed cap. Any hard-coded or configured maximum count (lane slots, worker pool size, `max-parallel`, runner concurrency groups that serialize unrelated work) is removed, not raised.
21. **No ceiling on concurrent reviews by the same reviewer.** One reviewer provider (Grok, Muse, Kimi, GLM, Gemini, Qwen, DeepSeek, Codex) may run any number of independent reviews at the same time, each in its own session, worktree, and verdict record. Reviewer "busy" is no longer a reason to wait or reroute; only a real provider refusal (quota, rate limit, auth, crash) or a Step 7 non-start triggers reroute. Independence rules stay: one head still needs distinct reviewers where the policy requires it, and a review never reuses another review's session.
...
- Transfer `popcre/shared-db` to `popcre/shared-db` and mutate its live GitHub ruleset: follow #2530; planning is not authorization.
...
#### Step 7A — remove the remaining concurrency ceilings (decisions 20–21)

Inventory every place that caps concurrent sub-agents, author lanes, runner jobs, or same-provider reviews, in both repositories: reviewer lease/slot and "busy" logic, `ai-*` reviewer wrappers and their lock files, orchestrator refill and worker-pool limits, workflow `concurrency:` groups and `max-parallel`, runner labels that force single-threading, and skill or rule text that tells sessions to wait for a free slot. Remove each numeric cap. Keep only exact-conflict admission, the three serialized stage leases, and back-off/reroute on real provider refusals. Per-review isolation (own session, worktree, verdict file, lock keyed by review ID not provider) must be proven before a provider-wide lock is removed.

**Verification gate:** fixtures show N unrelated authors, N sub-agents, and N reviews by one provider all admitted with no count check; a real provider refusal still backs off and reroutes; two same-provider reviews never share session or verdict state. **Live proof:** at least three reviews by the same provider running at the same time on different PRs, each producing its own recorded verdict, and runner jobs for unrelated PRs starting without waiting on each other.

#### Step 8 — execute the organization transfer and native merge queue plan

Do not duplicate the existing plan. Execute `popcre/shared-db/plan_shared_db_popcre_transfer_merge_queue.md` from its STATUS Step 0 after Albert names the exact transfer/settings action. Preserve repository identity, redirects, integrations, required checks, consumer sync, and direct guarded merging until the native queue is proven.
...
- shared-db: `C:\repos\shared-db`, GitHub currently `popcre/shared-db`, target `main`; expected future owner `popcre` only after Step 8.
