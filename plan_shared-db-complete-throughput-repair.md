...
| 1. Consume the four independently owned prerequisite repairs | 🟨 code landed, not accepted | 2026-09-15 | #2705, #2709 and #2715 are CLOSED. #2716 is still OPEN: shared-db PR #2736 merged, and the ai-devops policy half merged as PR #412 (`9d02b382`). NOT ACCEPTED: shared-db #2716 is still OPEN and no live fully-qualified automatic promotion or live refusal-path proof exists. |
...
| 9. Rewrite and install the operating rules without a flag day | ⬜ open | 2026-09-15 | Canonical and installed rules agree; legacy in-flight work remains safely executable. PR #412 (`9d02b382`) removed the canonical contrary evidence and its drift tests now guard every copy. NOT ACCEPTED: installed-file equality across the machine fleet is still unproven. |
