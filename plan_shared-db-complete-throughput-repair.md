...
| 7A. Remove every numeric concurrency ceiling on sub-agents, runners, and same-reviewer reviews | ⬜ open | 2026-09-16 | Added by Albert's ruling 2026-09-16 (locked decisions 20–21). No code yet. Owner: unassigned; non-orchestrator tooling (no database structure change). |
