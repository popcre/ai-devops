...
| 2. Enforce two-sided structural admission, urgent application-unblock priority, and finish-first scheduling | 🟨 partly live-proven | 2026-09-18 | Code: #2727 via PR #2738 (`5d89c5e2`); named holds via u2giants/shared-db PR #3049 (`35fda1f1`). LIVE: version re-reservation without closing the PR (claim #3005 kept, PR #3007 kept, supersession ref `refs/db-claim-supersessions/3005-20260916001923`). NOT ACCEPTED: no live hold has yet recorded a `hold_reason` naming its lease holder or conflicting claim, and no live refusal of an unrelated production hold exists (GitHub search for `hold_reason` finds only the code issues #3048/#3049). u2giants/shared-db#3027 was closed 2026-09-16 claiming all steps proven; for this row that claim covered the merge only. Evidence: shared-db `tests/verification/shared-db-throughput/2026-09-16-live-acceptance-steps-1-3-6.md` and `…-steps-2-2a-4-7.md`; re-verified 2026-09-18 against live runs, refs and the production ledger. Live proof owner: [shared-db#3241](https://github.com/u2giants/shared-db/issues/3241). |
