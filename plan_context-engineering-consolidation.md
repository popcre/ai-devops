...
| 11. Re-audit and tighten the startup instructions | ✅ done | 2026-08-22 | Current source: always-loaded 12,449 bytes, startup-routed 10,942, Claude manifest 15,293, Codex manifest 12,904; all are below their prior targets and ratcheted. Effective installed globals are separately measured at the corrected 21,808-byte machine baseline, including preserved machine sections. Strict audit has zero safety, parity, link, overlap, or budget findings. Current rules moved to `docs/context-spec.md`; tables render from audit JSON. |
...
[`docs/context-spec.md`](docs/context-spec.md). Machine sections
