...
not go to the orchestrator. When you keep leftover live-proof work, open one
issue per unproven step and start one session per issue. Do not bundle several
leftover proofs into one ticket or one chat, and never save several unproven
steps to hand to a later session. Handing over means something completely
