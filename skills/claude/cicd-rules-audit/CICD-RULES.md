...
* do not turn optional speedups into hidden policy; document exactly when they apply and what they skip §28 Documentation and AI-guidance files Operational documentation, architecture notes, AI-guidance files, and similar repo knowledge files are not the same thing as production runtime assets.
