...
| `AI_MEMORY_MAX_AGE_HOURS` | Maximum age before `sync-if-stale` runs a full round trip | `24` |
| `AI_MEMORY_HEALTH_STATE` | Prior health report used to show the next audit trend | `~/.cache/ai-memory-health.trend` |
