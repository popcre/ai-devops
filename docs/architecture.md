...
Muse, Grok, Qwen, Gemini, DeepSeek, plus the Claude and Codex approval-gate wrappers, and StepFun, drawn only on Ubuntu/Linux machines) receive reviews. Unsupported metadata
