...
| [`plan_windows-runner-maintenance-elevation.md`](../plan_windows-runner-maintenance-elevation.md) | [#262](https://github.com/popcre/ai-devops/issues/262) | Step 4 verification; focused evidence is green, full clean-host matrix and exact-head security approval remain before landing |
