...
| Reviewer investigation mode | [`../plan_reviewer-investigation-mode-option-b.md`](../plan_reviewer-investigation-mode-option-b.md) STATUS, issue #253 and provider child | Investigation is advisory; formal review stays read-only; do not bundle CLI upgrades; children including Grok #513 are independent; do not implement #249 here |
