...
| `ai-muse` native-engine parity or default switch | [`../plan_ai-muse-native-engine-parity.md`](../plan_ai-muse-native-engine-parity.md) STATUS, issue #542 | Read the STATUS table first; keep both engines; fail closed on usage honesty; flip only after live qualification |
