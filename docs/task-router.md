...
| Bundled leftover live proofs or one chat given a whole programme of unproven steps | [`../plan_live-proof-session-sizing.md`](../plan_live-proof-session-sizing.md) STATUS, issue #511 | One unproven live-behavior outcome per session; do not add steps onto a live proof owner |
