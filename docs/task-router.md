...
| Windows CI, Blacksmith, runner, or local reviewer series | [`../plan_blacksmith-windows-throughput.md`](../plan_blacksmith-windows-throughput.md) STATUS, [`blacksmith-windows-runners.md`](blacksmith-windows-runners.md), [`self-hosted-windows-runner.md`](self-hosted-windows-runner.md), [`independent-windows-runner-setup.md`](independent-windows-runner-setup.md), [`critical-incidents.md`](critical-incidents.md) 2026-09-02 | Implement 3+3 only through the plan's cancellable sibling/recovery design; resolve current jobs, labels, pricing, and provider limits live |
