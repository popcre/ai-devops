...
- Reaching **4837**: online (Tailscale `<removed-protected-address>`) but SSH publickey denied,
...
- t16 Tailscale `100.96.219...`/`100.96.221.71` (offline); 4837 `<removed-protected-address>`;
  916 `<removed-protected-address>`.
