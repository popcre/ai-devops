...
| 4. Rewrite the shared-db and installed operating rules | ⬜ open | 2026-08-28 | Required replacement remains in §9.4. The interim blocker-response, truthful-worker, and live-refill ruling was added to the global templates and orchestrator skill/manual; do not mistake that bounded amendment for completing this step. |
