...
MENTION_ONLY=' bin/ai-claude-review bin/ai-deepseek-agent bin/ai-gemini bin/ai-glm bin/ai-kimi bin/ai-qwen tests/lib-selection.sh config/reviewer-ci-paths.txt '
