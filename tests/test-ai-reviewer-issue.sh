...
printf '{"repo":"%s","head":"%s","session_id":"x","caller":"codex","prompt":"private code","total_tokens":42,"credential":"do-not-copy"}\n' "$REPO_CANON" "$HEAD" > "$TMP/state/grok/sessions/x/session.json"
