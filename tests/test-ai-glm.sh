...
check "ai-glm-agent stub exits nonzero"     "! '$REPO_ROOT/bin/ai-glm-agent' >/dev/null 2>&1"
check "ai-glm-agent stub names ai-glm"      "'$REPO_ROOT/bin/ai-glm-agent' 2>&1 | grep -q 'replaced by ai-glm'"
