...
PENDING_META="$TMP/pending-turn.json"
printf '{"name":"pending","remote_turn":{"state":"pending","started_at":"2026-09-10T00:00:00Z"}}\n' > "$PENDING_META"
...
check "GLM rechecks pending remote work only after claiming the session lock" "test '$ASK_LOCK_LINE' -lt '$ASK_PENDING_LINE'"
